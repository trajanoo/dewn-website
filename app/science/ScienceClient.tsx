  ...
  const hardcodedSections: Array<{ number: number; title: string; body: React.ReactNode }> = [
    {
      ...
      body: (
        <>
          <div className="space-y-4 text-[#363636] leading-relaxed mb-6">
    ...
    },
    {
      ...
      body: (
        <>
          <p className="text-[#363636] leading-relaxed mb-6">
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            {[
              ...
              <div key={i} className="flex items-baseline gap-3 text-sm">
                ...
                <span className="text-[#363636]">{item.value}</span>
              </div>
            ))}
          </div>
        </>
    ...
    return (
      <div className="pt-32 pb-24 lg:pt-40 lg:pb-36">
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          <ScrollReveal>
            <p className="text-xs tracking-[0.2em] uppercase text-[#363636] mb-3">Technical Documentation</p>
          ...
          <ScrollReveal delay={0.1}>
            <div className="bg-muted/30 border border-border/50 rounded-xl p-6 mb-16">
              ...
              <p className="text-sm text-[#363636] leading-relaxed">{disclaimer}</p>
            </div>
          </ScrollReveal>
          ...
          {mergedSections.map((section, i) => (
            <ScrollReveal key={section.number} delay={0.15 + i * 0.05}>
              <div className="mb-16 pb-10 border-border/50">
                ...
                <div className="space-y-4 text-[#363636] leading-relaxed">
                  {Array.isArray(section.body) ? (
                    ...
                    section.body.split('\n\n').map((p: string, j: number) => (
                      <p key={j} className="text-[#363636] leading-relaxed">{p}</p>
                    ))
                  ) : null}
                </div>
              </div>
